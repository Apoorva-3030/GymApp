...
<head>
<meta charset="UTF-8">
<title>Plan Form | Gym Management System</title>
					...
					<form action="/admin/plans/save" method="post">
						...
						<div class="mb-3">
							<label class="form-label">Name</label> <input type="text"
								name="name" class="form-control" value="${plan.name}"
								placeholder="Enter plan name" required>
						</div>

						<!-- Duration -->
						<div class="mb-3">
							<label class="form-label">Duration (months)</label> <input
								type="number" name="duration" class="form-control"
								value="${plan.duration}" min="1" placeholder="e.g. 3" required>
						</div>
						...
						<div class="mb-4">
							<label class="form-label">Price</label> <input type="number"
								...
								value="${plan.price}" min="0" placeholder="e.g. 49.99" required>
						</div>

						<!-- Buttons -->
						<div class="d-flex justify-content-between">
							<a href="/admin/plans" class="btn btn-secondary"> Cancel </a>
							<button type="submit" class="btn btn-primary">Save Plan
							</button>
						</div>
